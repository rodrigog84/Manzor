    ...
    init: function() {
        ...
        this.control({
           ...
           /* 'facturasprincipal': {
            ...
            'buscarproductosfacturas button[action=seleccionarproductos]': {
                click: this.seleccionarproductos
            },            
            'buscarproductosfacturas button[action=buscar]': {
                click: this.buscarp
            },
...
//
    ...
    buscarproductos: function(){
        ...
        st.load();
        var edit = Ext.create('Infosys_web.view.ventas.BuscarProductos').show();
    ...
    seleccionarproductos: function(){
        ...
        var view = this.getBuscarproductosfacturas();
        var viewIngresa = this.getFacturasingresar();
        var grid  = view.down('grid');
        if (grid.getSelectionModel().hasSelection()) {
            var row = grid.getSelectionModel().getSelection()[0];
